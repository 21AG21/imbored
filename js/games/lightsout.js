...
(function () {
  ...
  function mount(root, api) {
    ...
    function start(lv) {
      ...
      par = Math.min(N * N - 2, 3 + level);
      /* scramble by pressing random cells — guarantees the board is solvable */
      const used = new Set();
      let guard = 0;
  ...
  Arcade.register({
    ...
    cat: 'brain',
    order: 22,
    blurb: 'Every light you touch flips its neighbours too. Deceptively hard, extremely quiet.',
    scoreLabel: 'Level',
    tags: ['grid', 'toggle', 'logic'],
    how: [
      'Clicking a light toggles it and the four lights directly around it.',
      'The goal is a completely dark board.',
      'Every board is generated by scrambling a solved one, so a solution always exists.',
      'Par is the number of scramble presses used — beating it means you found a shortcut.'
    ],
    mount
  });
})();
