 ...
 * the OutRun way (projected road segments), traffic to weave through, a dozen
...
(function () {
  ...
  Arcade.register({
    ...
    cat: 'action',
    order: 20,
    blurb: 'A proper arcade racer hiding in a browser tab — a curving, cresting pseudo-3D highway, traffic to thread, and a dozen stages that get twistier and busier. Floor it, keep it on the tarmac, and beat the clock. Jump to any stage whenever you like.',
    ...
    how: [
      ...
      'Reach the finish line to clear the stage and bank your time. Twelve stages get longer, curvier and more crowded as you go.',
