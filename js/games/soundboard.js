...
(function () {
  ...
  const SOUNDS = [
    ...
    { label: 'Bounce', emoji: '🤸', key: '5', play: () => { A.tone({ freq: 620, to: 180, dur: 0.28, type: 'sine', vol: 0.16 }); A.tone({ freq: 180, to: 380, dur: 0.2, type: 'sine', vol: 0.1, delay: 0.26 }); } },
    { label: 'Impact', emoji: '💥', key: '6', play: () => { A.tone({ freq: 74, to: 36, dur: 0.55, type: 'sine', vol: 0.3 }); A.noise({ dur: 0.22, cutoff: 220, vol: 0.16 }); } },
    ...
    { label: 'Error', emoji: '❌', key: '8', play: () => { A.tone({ freq: 130, dur: 0.5, type: 'sawtooth', vol: 0.16 }); A.tone({ freq: 123, dur: 0.5, type: 'sawtooth', vol: 0.16 }); } },
    ...
    { label: 'Sigh', emoji: '😐', key: 't', play: () => { A.tone({ freq: 164, to: 120, dur: 0.42, type: 'sawtooth', vol: 0.16 }); } },
    ...
    { label: 'Honk', emoji: '🦆', key: 's', play: () => { A.tone({ freq: 300, to: 240, dur: 0.12, type: 'sawtooth', vol: 0.16 }); A.tone({ freq: 280, to: 200, dur: 0.14, type: 'sawtooth', vol: 0.16, delay: 0.14 }); } },
  ...
  Arcade.register({
    ...
    cat: 'goof',
    order: 43,
    blurb: 'Eighteen unserious noises: air horn, sad trombone, rimshot, impact hit and more. Everything is synthesized live in the browser, with no sound files at all.',
